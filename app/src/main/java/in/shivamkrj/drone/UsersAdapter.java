...
public class UsersAdapter extends RecyclerView.Adapter<UsersViewHolder> {
    ...
    public UsersAdapter(Context context,ArrayList<UserData> usersList, ViewClickInterface viewClickInterface) {
    ...
    public void onBindViewHolder(@NonNull final UsersViewHolder usersViewHolder, int i) {
        UserData usersData = usersList.get(usersViewHolder.getAdapterPosition());
